...
const Navigation = () => {
  ...
  return (
    <div className=' flex flex-col gap-5 w-[30vh] bg-[white] p-4 h-[100vh]'>
      ...
      <div onClick={LogOut}  className='w-full  active:bg-[#4750AB] text-[#898989] flex justify-center cursor-pointer items-center gap-3 p-4 rounded-md active:text-white'><FiLogOut className='mr-6' size={30}/> 
